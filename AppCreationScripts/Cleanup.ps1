...
#>
   ...
   process
   {
    ...
    Write-Host "Removing 'app' (WebApp-OpenIDConnect-DotNet) if needed"
    $app=Get-AzureADApplication -Filter "identifierUris/any(uri:uri eq 'https://$tenantName/WebApp-OpenIDConnect-DotNet')"  
    if ($app)
    {
